                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div x-data="{ show:false}" @click.away="show = false" class="relative">
                                            ...
                                            <div x-show="show" class="absolute border-2 border-black-600 right-0 z-50" style="display:none;">
                                                <a href="{{ route('categories.edit', $category) }}" class="bg-gray-100 hover:bg-gray-400 block text-left px-3 leading-7">Edit</a>
                                                <a href="{{ route('categories.delete', $category) }}" class="bg-gray-100 hover:bg-gray-400 block text-left px-3 leading-7">Delete</a>
                                                <a href="{{ route('categories.status', $category) }}" class="bg-gray-100 hover:bg-gray-400 block text-left px-3 leading-7">{{ $category->status ? 'Inactive' : 'Active'}} </a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
