    ...
    <div class="mx-24 my-6 py-12 w-3/5">
        ...
        <div class="p-6 bg-white border-b border-gray-200">
            <form method="POST" action="{{ route('categories.store') }}" class="px-5">
                ...
                <!-- Buttons -->
                <div class="mt-4">
                    <button type="submit" name="action" value="save"  class="bg-gray-700 border-0.5 border-2 border-gray-500 font-bold hover: hover:bg-gray-700 hover:border-gray-900 text-white hover:text-white mx-auto px-4 py-1.5 rounded-md">
                        Create Category
                    </button>
                    <button type="submit" name="action" value="saveNxt" class="bg-gray-700 border-0.5 border-2 border-gray-500 font-bold hover: hover:bg-gray-700 hover:border-gray-900 text-white hover:text-white ml-4 px-4 py-1.5 rounded-md">
