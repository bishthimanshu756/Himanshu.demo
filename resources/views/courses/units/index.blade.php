    ...
    <div class="mx-24 my-6 py-12">
        ...
        <div class="bg-white px-6 py-4 rounded-md">
            <div class="w-full bg-white flex mb-4">
                <div class="object-fill w-1/4">
                    <img src="{{ url('storage/'.$course->image->image_path) }}" alt="image">
                </div>
                <div class="w-3/4 relative">
                    <a class="absolute bg-gray-100 border font-bold px-4 py-1 right-6 rounded-md text-blue-700 text-xs" href="{{ route('courses.edit',$course) }}">
        ...
        <div class="bg-white mt-8 px-4 py-2 mb-4">
            @foreach($units as $unit)
                <div class="mt-4 border py-2 px-4">
                    <div class="flex justify-between">
                        ...
                        <div class="flex flex-none w-14">
                            <a href="{{ route('courses.units.edit',[$course,$unit]) }}" class="mr-4">
                                <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="darkgreen" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                </svg>
                            </a>
                            <a href="{{ route('courses.units.delete', [$course, $unit]) }}" class="mr-2">
                                <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="red" viewBox="0 0 24 24" fill="currentColor">
