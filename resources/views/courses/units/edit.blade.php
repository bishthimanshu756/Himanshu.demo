<x-app-layout>
    <div class="mx-24 my-6 py-12">
        ...
        <div class="flex bg-white">
            ...
            <div class="mt-8 p-10 w-1/2">
                <div class="flex">
                    <div class="border text-center w-1/2">
                        <svg class="inline w-24 h-24 " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor">
                    ...
                    <div class="border text-center w-1/2 ml-8">
                        <svg class=" h-24  inline w-24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor">
                ...
                <div class="mt-8 flex">
                    <div class="border text-center w-1/2">
                        <svg class="h-24 inline w-24 " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
                    ...
                    <div class="border text-center w-1/2 ml-8 pt-2">
                        <svg class="h-24 inline w-24" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
